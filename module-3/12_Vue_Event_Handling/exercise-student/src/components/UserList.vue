  ...
  <div class="container">
    <table id="tblUsers">
      ...
      <tbody>
        ...
        >
          <td>
            <input type="checkbox" v-bind:id="user.id" v-bind:value="user.id" v-on:change="checkAllSelected" v-model="selectedUserIDs" />
          </td>
  ...
  methods: {
    ...
    flipStatus(id){
     ...
     enableSelectedUsers(){
       ...
       checkAllSelected(){
         if(this.selectedUserIDs.length === this.users.lenght){
