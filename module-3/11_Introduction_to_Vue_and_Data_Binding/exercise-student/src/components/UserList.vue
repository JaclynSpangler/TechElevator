  ...
  computed: {
    filteredList() {
      return this.users.filter((user) => {
        const containsFirstName = user.firstName.toLowerCase().includes(this.filter.firstName.toLowerCase());
        const containsLastName = user.lastName.toLowerCase().includes(this.filter.lastName.toLowerCase());
        const containsUsername = user.username.toLowerCase().includes(this.filter.username.toLowerCase());
        const containsEmailAddress = user.emailAddress.toLowerCase().includes(this.filter.emailAddress.toLowerCase());
        const containsStatus = user.status.includes(this.filter.status);
